"""
This function executes and processes the "show interfaces diagnostics optics | display xml" command
and returns all the data in a semi neat list that you can process in your program.
These are the values i chose to return and how i named them (Left side between the ') This can be
